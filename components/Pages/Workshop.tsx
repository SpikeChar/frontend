...
import { useGLTF, OrbitControls, ContactShadows, Environment, Center, Grid, PivotControls } from '@react-three/drei';
    ...
    <div className="relative w-full h-screen bg-[#050505] overflow-hidden flex flex-col pt-16 ">
      {isMobile ? (
        <div className="w-full h-screen bg-black flex items-center justify-center">
          <h1 className="text-white text-lg text-center">This site is not for Mobile. Please use this on a PC or Tablet.</h1>
        </div>
      ) : (
        <>
